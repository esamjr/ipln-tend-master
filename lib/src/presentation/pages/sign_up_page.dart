...
class SignUpPage extends StatefulWidget {
  final List<String> division = AppConfig.division;
            ...
            children: [
              ...
              DropdownButtonHideUnderline(
                child: DropdownButtonFormField2(
                  items: _addDividersAfterItems(widget.division),
                  decoration: CWidgetStyle.dropdownButtonDecoration(),
                  isExpanded: true,
                  hint: Text('Pilih divisi', style: Theme.of(context).textTheme.bodyMedium?.copyWith(color: ColorStyle.darkGrey),),
                  validator: (value) {
                    if (value == null) {
                      return 'Pilih divisi';
                    }
                  ...
                  menuItemStyleData: MenuItemStyleData(
                    customHeights: _getCustomItemsHeights(widget.division),
                  ),
                ),
              ),
              const SizedBox(
    ...
    if (_formSignUpKey.currentState!.validate()) {
      await BlocProvider.of<UserCubit>(context).submitSignUp(user: UserEntity(
          ...
          userInfo: {
            ...
            'worker_number': _idController.text,
